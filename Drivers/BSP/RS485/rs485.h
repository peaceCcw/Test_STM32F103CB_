...
#define RS485_RE_GPIO_CLK_ENABLE()          do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PD口时钟使能 */
...
#define RS485_UX                            USART1
#define RS485_UX_IRQn                       USART1_IRQn
#define RS485_UX_IRQHandler                 USART1_IRQHandler
#define RS485_UX_CLK_ENABLE()               do{ __HAL_RCC_USART1_CLK_ENABLE(); }while(0)  /* USART1 时钟使能 */
...
void rs485_receive_data(uint8_t *buf, uint8_t *len ,uint8_t t);/* RS485接收数据 */  
